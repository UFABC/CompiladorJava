...
public JujuLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("matematica", this), new Integer(17));
	literals.put(new ANTLRHashString("if", this), new Integer(10));
	literals.put(new ANTLRHashString("fimdacomparacao", this), new Integer(16));
	literals.put(new ANTLRHashString("end", this), new Integer(6));
	literals.put(new ANTLRHashString("begin", this), new Integer(13));
	literals.put(new ANTLRHashString("colocarumbagulhodemaiorigualprapodervalidaraexpressao", this), new Integer(14));
	literals.put(new ANTLRHashString("input", this), new Integer(18));
	literals.put(new ANTLRHashString("function", this), new Integer(4));
	literals.put(new ANTLRHashString("output", this), new Integer(21));
