...
public JujuLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("reserva", this), new Integer(6));
	literals.put(new ANTLRHashString("output", this), new Integer(13));
	literals.put(new ANTLRHashString("input", this), new Integer(10));
}
...
tryAgain:
	...
	public final void mINICIO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
